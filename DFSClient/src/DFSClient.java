...
public class DFSClient {
	...
	static final String[] MAIN_LIST_OPTIONS = { "Open a file for read", "Exit" };

	private static String[] currentMenuOptions = MAIN_LIST_OPTIONS;

	static ClientCommand[] MAIN_LIST_COMMANDS = { new OpenForReadCommand(), new ExitCommand() };
	 ...
	 * 
	 * @param options  a list of the prompts that should be given to the user
	 * @param commands the commands that should be assocated with each prompt
	 */
