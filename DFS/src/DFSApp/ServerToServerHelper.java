...
/**
 * DFSApp/ServerToServerHelper.java . Generated by the IDL-to-Java compiler
...
abstract public class ServerToServerHelper {
	...
	synchronized public static org.omg.CORBA.TypeCode type() {
		if (__typeCode == null) {
			__typeCode = org.omg.CORBA.ORB.init().create_interface_tc(DFSApp.ServerToServerHelper.id(),
					"ServerToServer");
		}
		return __typeCode;
	}
