...
public class ServerToServerImpl extends ServerToServerPOA {
	...
	/**
	 * @param orb the ORB object that servers can connect to
	 */
	 ...
	 * 
	 * @throws DFSApp.ServerToServerPackage.FileNotFoundFailure       if the file is
	 *                                                                not on this
	 *                                                                server
	 * @throws DFSApp.ServerToServerPackage.FileLockedForWriteFailure if the file is
	 *                                                                on this
	 *                                                                server, but
	 *                                                                locked for
	 *                                                                write
