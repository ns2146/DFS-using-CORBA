...
public class FileManager {
	...
	/**
	 * @param fileID the file we care about
	 ...
	 * @throws DFSFileDoesntExist if we can't find a file with that name
	 */
	 ...
	 * @param filePointer offset into the file we should start at
	 * @param chars       the number of characters we should read
